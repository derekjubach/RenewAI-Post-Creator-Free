...
$openai_model = get_option('renewai_openai_model', 'gpt-4o');
  ...
  <form method="post" action="" class="renewai-pc-settings-form">
    ...
    <div id="provider_settings" class="renewai-pc-settings-section" style="display: none;">
      ...
      <div id="openai_settings" class="provider-settings">
        <table class="renewai-pc-form-table">
          <tr class="top-align">
            <th><label for="renewai_openai_model">
                <?php esc_html_e('OpenAI Model', 'renewai-post-creator'); ?></label></th>
            <td>
              <select id="renewai_openai_model" name="renewai_openai_model">
                ...
                foreach ($models_to_use as $api_name => $friendly_name) {
                ?>
                  <option value="<?php echo esc_attr($api_name); ?>" <?php selected($openai_model, $api_name); ?>><?php echo esc_html($friendly_name); ?></option>
                <?php
                }
                ?>
              </select><br>

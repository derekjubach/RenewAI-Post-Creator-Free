...
if (!defined('RENEAI_PC__PLUGIN_DIR')) {
  define('RENEAI_PC__PLUGIN_DIR', dirname(__FILE__));
  define('RENEAI_PC__PLUGIN_URL', plugins_url(plugin_basename(RENEAI_PC__PLUGIN_DIR)));
}
// Directory and URL Constants
if (!defined('RENEAI_PC__NEWSLETTER_ADDR')) {
  define('RENEAI_PC__NEWSLETTER_ADDR', 'success@perpetuaiconsult.com');
}
if (function_exists('rpc_fs')) {
  rpc_fs()->set_basename(false, __FILE__);
} else {
  ...
  class RenewAI_Post_Creator
  {
    ...
    public function register_settings()
    {
      ...
      $providers_to_use = (rpc_fs()->can_use_premium_code__premium_only() ? $providers_premium : $providers_free);
    ...
    public function render_settings_page()
    {
      ...
      include RENEAI_PC__PLUGIN_DIR . '/pages/settings-page.php';
    }
    ...
    public function render_api_keys_page()
    {
      ...
      include RENEAI_PC__PLUGIN_DIR . '/pages/api-keys.php';
    }
    ...
    public function render_help_page()
    {
      ...
      include RENEAI_PC__PLUGIN_DIR . '/pages/help-page.php';
    }
    ...
    public function enqueue_scripts($hook)
    {
      ...
      wp_enqueue_style(
        ...
        RENEAI_PC__PLUGIN_URL . '/assets/css/admin-styles.css',
        array(),
        '1.0'
      );
      ...
      wp_enqueue_script(
        'renewai-script',
        RENEAI_PC__PLUGIN_URL . '/assets/js/perpetuai-script.js',
        ($is_gutenberg ? array(
          'jquery',
          'wp-blocks',
          'wp-element',
      ...
      if ('toplevel_page_renewai-post-creator-settings' === $hook) {
        wp_enqueue_script(
          'renewai-settings-page',
          RENEAI_PC__PLUGIN_URL . '/assets/js/settings-page.js',
          array('jquery'),
          '1.0',
          true
        );
    ...
    public function delete_log_file()
    {
      ...
      $log_file = RENEAI_PC__PLUGIN_DIR . '/renewai-log.txt';
      // Set up WP_Filesystem
      global $wp_filesystem;
      if (empty($wp_filesystem)) {
        require_once ABSPATH . '/wp-admin/includes/file.php';
    ...
    {
?>
      <div id="renewai-post-creator-meta-box">
